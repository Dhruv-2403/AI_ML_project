...
def find_model():
    paths = [
        ("models/lr_model.joblib", "models/tfidf_vectorizer.joblib"),
        ("../models/lr_model.joblib", "../models/tfidf_vectorizer.joblib"),
        ("lr_model.joblib", "tfidf_vectorizer.joblib")
    ]
...
def main():
    ...
    st.markdown("Analyze news articles using Logistic Regression Model")
